<template>
  <div>
    ...
    <el-button name="success-btn" type="success" class="c-show-code-button">
      <el-link name="watch-code" href="https://github.com/seeksdream/relation-graph/blob/master/doc/demo/Demo4SceneRelationship.vue"
